...
This module contains attention-based encoder components used in the MASAM model.
Adapted from Meta Platforms, Inc.
"""
...
class PromptEncoder(nn.Module):
    def __init__(
        ...
        self.mask_downscaling = nn.Sequential(
            ...
            nn.LayerNorm([mask_in_chans, image_embedding_size[0] // 4, image_embedding_size[1] // 4]),
            activation(),
